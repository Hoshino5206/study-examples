...
import com.hoshino.example.logback.constant.MDCConstant;
...
public class MDCUtils {
    ...
    public static String getRequestId() {
        return MDC.get(MDCConstant.REQUEST_ID_MDC_KEY);
    }

    public static String getRequestSeq() {
        return MDC.get(MDCConstant.REQUEST_SEQ_MDC_KEY);
    }

    public static String getUri() {
        return MDC.get(MDCConstant.URI_MDC_KEY);
    }
    ...
    public static String getLocalIp() {
        return MDC.get(MDCConstant.LOCAL_IP_MDC_KEY);
    }

    public static String nextRequestSeq() {
        return MDC.get(MDCConstant.NEXT_REQUEST_SEQ_MDC_KEY);
    }
    ...
    public static String getCookie(String name) {
        return MDC.get(MDCConstant.COOKIE_KEY_PREFIX + name);
    }
