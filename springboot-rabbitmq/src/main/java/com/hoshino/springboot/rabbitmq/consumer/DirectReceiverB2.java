...
public class DirectReceiverB2 {

    @RabbitHandler
    public void onMessage(@Payload String message){
        System.out.println("消费者2接收 DirectQueue_B Message content : " + message);
    }

    @RabbitHandler
    public void process(@Payload Map<Object, Object> message) {
        System.out.println("消费者2接收 DirectQueue_B Message content : " + message.toString());
    }
